...
var option1 = ({
    ...
    series: [{
        ...
        radus: '55%',
        data: [
            { value: 400, name: 'Web前端' },
            { value: 335, name: 'PHP开发' },
            { value: 310, name: '产品经理' },
            { value: 274, name: '软件测试' },
            { value: 235, name: 'UI设计' }
        ],
...
var optionPie = ({
        ...
        series: [{
            ...
            // 图形样式，有 normal 和 emphasis 两个状态。normal 是图形在默认状态下的样式；emphasis 是图形在高亮状态下的样式
            //每个扇形颜色也可以通过分别设置 data 下的数据项实现。
            // itemStyle: {
            //     normal: {
            //         color: '#c23531',
            //         //阴影样式设置
...
var data4 = rawData.map(function (item) {
